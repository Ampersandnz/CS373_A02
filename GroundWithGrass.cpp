...
{
	// compute texture coordinate where egg hits the ground and copy texture image of a smahed egg in there
...
/*	glBindTexture(GL_TEXTURE_2D, texName);
    glTexSubImage2D(GL_TEXTURE_2D, 0, xOffset, yOffset, 
                         eggTextureWidth, eggTextureHeight, GL_RGBA,
                         GL_UNSIGNED_BYTE, eggTexture);
*/
	int k,l; 
	for(k=0;k<eggTextureHeight;k++)
		for(l=0;l<eggTextureWidth;l++)
